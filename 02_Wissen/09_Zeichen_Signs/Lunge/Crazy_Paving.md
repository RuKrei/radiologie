...
> 🖼️ **Fleischner Referenzbild (Fig. 23):**
> ![Crazy Paving Pattern](../../../media/crazy_paving_fleischner.png)
> *(Bitte entsprechendes Bild aus dem Fleischner-PDF hierher ziehen und als `crazy_paving_fleischner.png` im Ordner `media/` speichern)*
...
- [Radiopaedia: Crazy Paving](https://radiopaedia.org/articles/crazy-paving)
