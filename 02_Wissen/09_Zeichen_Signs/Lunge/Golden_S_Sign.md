...
> ![Golden S Sign](../../../media/golden_s_sign_fleischner.png)
> *(Bitte entsprechendes Bild aus dem Fleischner-PDF hierher ziehen und als `golden_s_sign_fleischner.png` im Ordner `media/` speichern)*
...
- Zentrales Bronchuskarzinom mit poststenotischer Atelektase (meist RUL)
