...
> ![Flat Waist Sign](../../../media/flat_waist_sign_fleischner.png)
> *(Bitte entsprechendes Bild aus dem Fleischner-PDF hierher ziehen und als `flat_waist_sign_fleischner.png` im Ordner `media/` speichern)*
...
- Schwere linksseitige Unterlappenatelektase

## Weiterführende Links
- [Radiopaedia: Flat Waist Sign](https://radiopaedia.org/articles/flat-waist-sign)
