...
> ![Hampton Hump](../../../media/hampton_hump_fleischner.png)
> *(Bitte entsprechendes Bild aus dem Fleischner-PDF hierher ziehen und als `hampton_hump_fleischner.png` im Ordner `media/` speichern)*
...
- [Radiopaedia: Hampton Hump](https://radiopaedia.org/articles/hamptons-hump)
