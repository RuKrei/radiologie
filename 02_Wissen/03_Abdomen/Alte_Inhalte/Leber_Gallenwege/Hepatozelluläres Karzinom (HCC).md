...
### Was sieht man korrelierend in dieser Methode?
 Kleine Tumoren unter 3 cm und differenzierte Tumoren stellen sich meist echoarm dar, häufig findet sich jedoch auch ein sehr gemischtes Echomuster. In der zirrhotischen Leber ist das Parenchym diffus echoreich mit unregelmäßigem Rand. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Mit Kontrastmittel erreicht die Sonografie eine Genauigkeit, die der von MRT und CT vergleichbar ist. Die Methode ist gut geeignet für diagnostische Punktionen.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 Die Angiografie spielt für die reine Diagnostik keine Rolle mehr, ist aber therapeutisch wichtig. 
### Was kann man nicht sehen?
 Konventionelle Röntgenaufnahmen spielen in der Primärdiagnostik des HCC keine Rolle.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 Obligat ist ein multiphasisches MDCT mit arterieller Phase (nach ca. 15 bis 20 Sekunden), portalvenöser Phase (nach 60 bis 70 Sekunden) und Spätphase (nach 180 Sekunden). Charakteristisch ist eine rasche Kontrastmittelaufnahme in der arteriellen Phase (Wash-in) und eine rasche Auswaschung mit Kontrastumkehr in der Spätphase. In der arteriellen Phase zeigt sich oft ein hypervaskularisierter Randsaum. 
### Was kann man nicht sehen?
 Nativ weist das HCC eine etwas geringere Dichte als die umgebende Leber auf. Nekrotische Veränderungen nehmen kein Kontrastmittel auf. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Einige Tumoren werden erst in der Spätphase sichtbar. HCC können fleckige Bereiche makroskopischen Fetts enthalten,.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 In T1-gewichteten Sequenzen ist das HCC meist homogen hypointens, kann aber durch Fett, Kupfer oder Blut auch hyperintens sein. In T2-gewichteten Sequenzen stellt es sich häufig hyperintens dar, wobei die Intensität mit zunehmender Entdifferenzierung zunehmen kann. In der dynamischen MRT ist eine starke Kontrastmittelanreicherung in der arteriellen Phase und eine rasche Auswaschung (Wash-out) pathognomonisch. Ein spezifisches Zeichen ist das Nodule-in-Nodule-Phänomen, bei dem innerhalb eines hypointensen dysplastischen Knotens ein hyperintenser Fokus (das HCC) sichtbar ist, der arterielles Enhancement zeigt,. 
### Was kann man nicht sehen?
 Über 90 Prozent der HCC zeigen nach Gabe von leberspezifischem Kontrastmittel (Gd-EOB-DTPA) keine Aufnahme in der hepatobiliären Phase (1 Stunde post injectionem), da sie keine funktionierenden Hepatozyten enthalten,. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Kleine HCC-Herde unter 2 cm zeigen aufgrund einer gemischten Blutversorgung möglicherweise kein venöses Wash-out und sind nur in der arteriellen Phase hyperintens. Die Sensitivität kann, insbesondere in der zirrhotischen Leber, durch die Verwendung der Diffusionsbildgebung (DWI) erhöht werden, da HCC eine deutliche Diffusionsrestriktion zeigen. Tumorthromben in der Pfortader sind T2-hyperintens und nehmen im Gegensatz zu benignen Thromben arteriell Kontrastmittel auf.
...
Cholangiozelluläres Karzinom: Zeigt relativ typisch eine Einziehung der Leberkapsel, eine meist späte Kontrastmittelanreicherung (nach 10 Minuten) und oft eine Erweiterung von Gallengängen. Kleine intrahepatische Cholangiokarzinome unter 3 cm können jedoch ein ähnliches Enhancement wie HCC zeigen.

Hypervaskularisierte Metastasen: Treten meist als multiple und kleinere Herde auf.

Regeneratknoten: Sind in der MRT meist T1-iso- bis hyperintens und T2-hypointens und zeigen nach Kontrastmittelgabe im Vergleich zum umgebenden Lebergewebe ein geringeres Signal.
