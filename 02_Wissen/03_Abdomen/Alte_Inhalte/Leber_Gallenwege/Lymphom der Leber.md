...
### Zu welchen pathologischen Veränderungen kommt es?
 Es lassen sich vier unterschiedliche Formen unterscheiden: ein diffuser Typ mit Hepatomegalie, ein multifokaler Typ mit glatt begrenzten Läsionen, ein miliarer Typ und eine lymphatische Infiltration per continuitatem entlang der Pfortader,. 
### Zu welchen morphologischen Veränderungen kommt es?
 Das primäre Lymphom zeigt sich meist als gut abgrenzbarer, solitärer Tumor, der groß sein kann und zentrale Nekrosen oder Fibrosen aufweist; eine diffuse Ausbreitung ist selten. Das sekundäre Lymphom führt zu einer vergrößerten Leber und zeigt sich diffus infiltrativ oder als multiple Knoten. 
### Zu welchen Komplikationen kann es kommen?
 Es kommt zu einer Hepatomegalie.

## Sonografie
 
### Was sieht man korrelierend in dieser Methode?
 Es zeigt sich meist eine echoarme bis echofreie Raumforderung.
...
Fokale noduläre Hyperplasie (FNH) und Adenom: Diese zeigen eine sehr intensive knotige Kontrastmittelanreicherung, oft eine zentrale Narbe, die Kontrastmittel aufnimmt, und speichern hepatobiliäre Gadolinium-Verbindungen in der Spätphase.

Hepatozelluläres Karzinom: Dieses tritt meist in einer zirrhotischen Leber auf, zeigt häufiger eine Gefäßinfiltration und geht mit einem erhöhten Alpha-Fetoprotein einher.

Metastasen: Meist ist eine Primärerkrankung bekannt.

Fettleber: Zeigt ein vermindertes Signal in T1-gewichteten Out-of-Phase-Sequenzen.

Pilzinfektion (Kandidose): Beim miliaren Typ des Lymphoms sind Mikroabszesse auf dem Boden einer Pilzinfektion eine Hauptdifferenzialdiagnose; der miliaren Lymphomform fehlt im Gegensatz zur Pilzinfektion oft die ringförmige Kontrastmittelanreicherung.
