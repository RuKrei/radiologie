...
### Zu welchen pathologischen Veränderungen kommt es?
 Es bilden sich multiple kleine oder einzelne große Herde. Anfänglich enthalten diese oft reichlich Debris, mit zunehmender Reifung verflüssigt sich der Inhalt. 
...
### Was sieht man korrelierend in dieser Methode?
 Meist zeigt sich eine echoarme bis echofreie rundliche Raumforderung, die bisweilen eine irreguläre Wand erkennen lässt. Der Inhalt kann septiert wirken und Debris enthalten. 
### Was kann man nicht sehen?
 Vor der Einschmelzung kann der Befund auch echoreich sein. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Gas im Abszess erscheint als sehr echodichte Struktur mit Schallschatten.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 In 25 bis 35 Prozent der Fälle finden sich Begleitsymptome wie ein rechtsseitiger Zwerchfellhochstand, ein entzündliches Infiltrat im rechten Unterlappen oder ein rechtsseitiger Pleuraerguss.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 Nativ stellt sich der Abszess hypodens dar. Nach Kontrastmittelgabe zeigt sich ein unterschiedlich breiter Saum mit Kontrastmittelaufnahme,. Das Cluster-Zeichen, eine multilokuläre Ansammlung kleiner Flüssigkeitskollektionen, kann auf einen pyogenen Abszess hindeuten. 
### Was kann man nicht sehen?
 Die zentrale Nekrose nimmt kein Kontrastmittel auf. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Bei kleinen Candida-Abszessen zeigt die arterielle Phase mehr Herde als die portalvenöse Phase. Die CT ist häufig das Instrument der Wahl zur bildgesteuerten Anlage von Drainagen zur Abszesssanierung. Eitrige Leberabszesse sind bildmorphologisch nicht zuverlässig von Amöbenabszessen zu unterscheiden.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 In T1-gewichteten Sequenzen zeigt sich ein sehr niedriges Signal, in T2-gewichteten Sequenzen ein sehr hohes Signal. Es findet sich eine Kapsel von unterschiedlicher Dicke, die Kontrastmittel aufnimmt. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Mit der MRCP kann gegebenenfalls eine biliäre Ursache nachgewiesen werden.
...
Zystadenom: Ist ein septierter Tumor ohne Fiebersymptomatik.

Zystisch zerfallender Tumor: Weist häufig Areale soliden Gewebes auf, das unterschiedlich Kontrastmittel aufnimmt.

Metastasen: Zeigen kein Fieber; kleine Metastasen mit ringförmiger Anreicherung sind morphologisch oft nicht von Abszessen zu unterscheiden.

Amöbenabszess: Morphologisch schwer vom pyogenen Abszess zu unterscheiden; die Differenzierung erfolgt mikrobiologisch.
