...
### Was sieht man korrelierend in dieser Methode?
 Man erkennt zwei Gallenblasenlumina. Diese liegen entweder parallel bei einem gemeinsamen Ductus cysticus oder unterschiedlich weit voneinander entfernt, wenn sie jeweils einen eigenen Ductus cysticus besitzen. 
...
### Was sieht man korrelierend in dieser Methode?
 Konventionelle Röntgenverfahren sind für den Nachweis nicht mehr indiziert. In der ERCP oder PTC lässt sich die Anomalie sicher nachweisen, diese Verfahren werden jedoch aufgrund ihres invasiven Charakters nicht primär zur Diagnostik eingesetzt. 
### Was kann man nicht sehen?
 Ohne Kontrastmittelfüllung (wie bei ERCP) ist die Weichteilanatomie nicht beurteilbar. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die Methode ist veraltet und spielt diagnostisch keine Rolle mehr.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 In der Computertomografie zeigen sich zwei Gallenblasenlumina. Nach Gabe von gallengängigen Kontrastmitteln ist ein möglicher Nachweis einer Kommunikation mit dem Gallengangsystem möglich. 
### Was kann man nicht sehen?
 Die genaue Anatomie der Gangverbindung ist ohne spezifisches biliäres Kontrastmittel oft schwer abzugrenzen. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Eine Verwechslung mit zystischen Leberläsionen ist möglich, wenn die biliäre Anbindung nicht dargestellt wird.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 Die MRT mit MRCP gilt als Methode der Wahl. Es stellen sich zwei Gallenblasenlumina dar. In der MRCP lässt sich der Ductus cysticus meist gut darstellen, was eine Unterscheidung der anatomischen Varianten (Y-Form vs. eigener Gang) ermöglicht,. 
### Was kann man nicht sehen?
 Kleine Steine können der MRT entgehen. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Eine intrahepatische Lage der zweiten Gallenblase muss als solche erkannt und von anderen zystischen Läsionen abgegrenzt werden.
...
Phrygische Mütze: Eine umgeschlagene Gallenblase kann in bestimmten Schnittebenen zwei Lumina vortäuschen.
