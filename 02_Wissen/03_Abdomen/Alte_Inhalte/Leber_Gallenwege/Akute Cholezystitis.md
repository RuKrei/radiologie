...
---
------
PEG = Cholezystolithiasis, Gallenblasenentzündung, Murphy-Zeichen
Erstellt: 2026-02-28
...
-   Gallenblasenhydrops (Querdurchmesser > 4-5 cm).
-   Pericholezystische Flüssigkeit.
-   Impaktierter Stein im Gallenblasenhals/Ductus cysticus.

## Sonografie
### Was sieht man korrelierend in dieser Methode?
**Methode der Wahl (Sensitivität > 90%).**
-   **Steine:** Echoreicher Reflex mit dorsalem Schallschatten. (Achtung: Sludge hat keinen Schallschatten!).
-   **Wandverdickung:** > 3 mm (dreigeschichtet).
-   **Sonografisches Murphy-Zeichen:** Maximale Druckdolenz direkt über der Gallenblase mit dem Schallkopf (spezifischstes Zeichen!).
-   **Hydrops:** Vorwölbung der Vorderwand, kugelige Form.
...
## CT
### Was sieht man korrelierend in dieser Methode?
Indiziert bei Komplikationen (Perforation, Abszess) oder Unklarheit.
-   **Wand:** Verdickt, kontrastmittelaufnehmend (Mucosa).
-   **Fettgewebe:** "Stranding" (imbibiertes Fett) um die Gallenblase.
-   **THAD (Transient Hepatic Attenuation Difference):** Reaktive Hyperämie des angrenzenden Leberparenchyms (Segment IVb/V) in der arteriellen Phase (durch Entzündung bedingte arterielle Hyperperfusion).
-   **Steine:** Nur ca. 15-20% der Steine sind verkalkt und im CT sicher sichtbar! Cholesterinsteine sind oft isodens zur Galle.
-   **Emphysematöse Cholezystitis:** Gas in der Wand oder im Lumen (Notfall!).

### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
-   Gangränöse Cholezystitis: Wandunterbrechung, fehlendes Wandenhancement (Nekrose), intraluminale Membranen.

## MRT
### Was sieht man korrelierend in dieser Methode?
Alternativmethode (z.B. Schwangere) oder zur Abklärung des Gallengangssystems (MRCP).
-   **Steine:** Signalaussparungen in der T2-hellen Galle.
-   **Wandödem:** T2-hyperintens.
-   **Pericholezystische Flüssigkeit:** T2-hyperintens.
