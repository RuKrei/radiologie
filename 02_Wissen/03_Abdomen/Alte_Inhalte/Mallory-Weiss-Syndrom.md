...
Longitudinale Schleimhautrisse (Mukosa/Submukosa) am gastroösophagealen Übergang oder knapp darunter im Kardia-Bereich (nicht transmural wie Boerhaave!).
### Zu welchen morphologischen Veränderungen kommt es?
Blutende Läsion, linear.

## Endoskopie
### Was sieht man korrelierend in dieser Methode?
Diagnostischer Goldstandard!
- Aktive Sickerblutung oder Koagel auf einem Riss (Längsverlaufend).

## Röntgen
### Was sieht man korrelierend in dieser Methode?
Ösophagusbreischluck:
- Oft negativ!
- Sensitivität gering. Nur bei Bariumpassage evtl. Kontrastmittelansammlung in der Lazeration (Strichförmig).
