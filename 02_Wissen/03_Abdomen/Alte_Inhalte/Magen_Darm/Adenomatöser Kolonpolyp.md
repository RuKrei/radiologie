...
### Zu welchen Komplikationen kann es kommen?
 Die wichtigste Komplikation ist der Übergang in ein kolorektales Karzinom.

## Sonografie
 
### Was sieht man korrelierend in dieser Methode?
 Die Sonografie ist nicht die Methode der Wahl zur primären Detektion von Kolonpolypen, da die Sensitivität für intraluminale Prozesse limitiert ist.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 Im Doppelkontrast-Bariumeinlauf zeigen sich Polypen als Füllungsdefekte. Bei villösen Adenomen kann Barium in die Zwischenräume der zottenartigen Oberfläche eindringen und ein charakteristisches Muster erzeugen, das einem Hochflorteppich ähnelt.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 In der CT-Kolografie stellen sich Polypen als weichteildichte Wandveränderungen dar, die in das lufthaltige Lumen ragen,. Sie sind ab einer Größe von 3 mm nachweisbar. Adenome können im Gegensatz zu Stuhlresten Kontrastmittel aufnehmen. 
### Was kann man nicht sehen?
 Die Differenzierung zwischen hyperplastischen und adenomatösen Polypen ist rein morphologisch in der CT schwierig, wobei Adenome tendenziell größer sind (oft über 1 cm).

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 In der MR-Kolografie sind Polypen ab einer Größe von 5 mm nachweisbar. Adenome nehmen meist kräftig Kontrastmittel auf, was sie von hyperplastischen Polypen unterscheidet. In der sogenannten Dark-lumen-Technik (mit T1-gewichteten Sequenzen und intravenöser Kontrastmittelgabe) erscheint die Darmwand und der Polyp signalreich vor einem signalarmen Lumen. In der Bright-lumen-Technik imponieren sie als Füllungsdefekte.
...
Divertikel: Können im Nativbild durch einen hyperdensen Ring auffallen und lassen sich meist einer extraintestinalen Lage zuordnen (Ausstülpung statt Vorwölbung).

Lipome: Weisen in der CT fettäquivalente Dichtewerte auf.
