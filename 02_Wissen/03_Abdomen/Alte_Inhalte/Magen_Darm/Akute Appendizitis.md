...
### Zu welchen pathologischen Veränderungen kommt es?
 Es handelt sich um eine Entzündung der Appendix vermiformis infolge einer Obstruktion, die von einem nicht destruktiven (katarrhalischen) Stadium zu destruktiven Stadien (ulzerophlegmonös, gangränös) bis hin zur Perforation fortschreiten kann.


### Zu welchen morphologischen Veränderungen kommt es?
 Morphologisch zeigt sich eine ==Dilatation== der Appendix (Durchmesser über 6 mm), eine ==Wandverdickung== (über 2 mm) sowie eine entzündliche Reaktion des umgebenden Gewebes (==Fettgewebsimbibierung==, Stranding),,,. Ein ==Appendikolith== kann als ursächliches Agens vorhanden sein,.
...
### Was sieht man korrelierend in dieser Methode?
 Die Sonografie ist oft die primäre Methode, insbesondere bei Kindern und jungen Erwachsenen. Die Appendix stellt sich als fingerförmig blind endende, tubuläre Struktur dar, die nicht komprimierbar ist,. Im Querschnitt zeigt sich das typische Kokarden-Phänomen oder ==[[Target-Zeichen]]==. Der Durchmesser beträgt über 6 bis 7 mm, die Wanddicke über 3 mm,. Im Farbdoppler zeigt sich eine vermehrte Vaskularisation (==Hyperämie==). Ein Appendikolith stellt sich als echoreicher Reflex mit dorsalem Schallschatten dar. Periappendizitische ==Flüssigkeitsansammlungen== weisen auf eine Perforation oder Abszedierung hin.


### Was kann man nicht sehen?
 Eine retrozäkale Appendix kann durch Luftüberlagerung der Darstellung entgehen. Bei adipösen Patienten ist die Beurteilbarkeit eingeschränkt und die Appendix oft nicht darstellbar.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Luft im Lumen der Appendix spricht in der Regel gegen eine akute Entzündung. Ein lokalisierter Schmerz unter Kompression mit dem Schallkopf ist ein wichtiges diagnostisches Kriterium.
...
### Was kann man nicht sehen?
 Die entzündete Appendix selbst ist im Röntgenbild nicht direkt sichtbar. Freie Luft bei Perforation ist im konventionellen Röntgenbild selten sichtbar.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Eine unauffällige Röntgenaufnahme schließt eine Appendizitis nicht aus.
...
### Was kann man nicht sehen?
 Eine normale Appendix kann manchmal schwer zu identifizieren sein, wenn wenig intraabdominales Fett vorhanden ist.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Eine mit Luft oder oralem Kontrastmittel gefüllte Appendix normaler Weite schließt eine Appendizitis in der Regel aus,. Bei älteren Patienten sollte immer ein perforiertes Zäkumkarzinom als Differenzialdiagnose in Betracht gezogen werden.
...
### Was sieht man korrelierend in dieser Methode?
 Die MRT zeigt eine verdickte Appendix (Durchmesser über 7 mm, Wand über 2 mm). In T2-gewichteten Sequenzen (z. B. STIR) zeigt sich ein hyperintenses Signal (Ödem/Flüssigkeit) in der Wand und im umgebenden Fettgewebe. Nach Kontrastmittelgabe (falls durchgeführt) erfolgt eine starke Anreicherung. Vergrößerte Lymphknoten sind ebenfalls darstellbar.


### Was kann man nicht sehen?
 Appendikolithen sind im MRT schwerer zu identifizieren als im CT.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die MRT ist besonders bei Schwangeren und Kindern indiziert, um eine Strahlenbelastung zu vermeiden,.
