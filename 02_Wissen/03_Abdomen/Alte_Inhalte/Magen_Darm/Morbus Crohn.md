...
### Zu welchen pathologischen Veränderungen kommt es?
 Es handelt sich um eine transmurale Entzündung, die alle Wandschichten betrifft und sich diskontinuierlich ausbreitet (skip lesions), sodass sich gesunde und befallene Darmabschnitte abwechseln,. Im akuten Stadium kommt es zu Wandverdickungen und Ödemen, im chronischen Stadium zu Fibrosierung und fettiger Degeneration der Submukosa,. 
...
### Was sieht man korrelierend in dieser Methode?
 Die Sonografie ist wichtig für die Primärdiagnostik und zeigt Darmwandverdickungen sowie im floriden Stadium eine starke Durchblutung (Hypervaskularisation). Begleitend können freie Flüssigkeit, Abszesse, Konglomerattumoren und eine mesenteriale Lymphadenopathie diagnostiziert werden. Eine verminderte Peristaltik der verdickten Abschnitte und Stenosen sind ebenfalls nachweisbar. 
### Was kann man nicht sehen?
 Die Methode hat Limitationen in der Lokalisationsdiagnostik und beim Ausschluss tiefer gelegener Komplikationen. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Der Ausschluss von Komplikationen wie einer Perforation ist sonografisch eingeschränkt möglich.
...
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Wegen der Strahlenbelastung und der Verfügbarkeit von Schnittbildverfahren spielen diese Methoden heute eine untergeordnete Rolle.
...
### Was sieht man korrelierend in dieser Methode?
 Die MR-Enterografie zeigt im akuten Stadium eine deutliche Wandverdickung mit hohem Signal in T2-gewichteten Sequenzen (submuköses Ödem) und kräftiger Kontrastmittelaufnahme,. In der diffusionsgewichteten Bildgebung (DWI) zeigt sich bei aktiver Entzündung eine Diffusionsrestriktion. Ein Stern-Zeichen deutet auf enteroenterale Fisteln hin. Fibrostenosen zeigen kein Ödem und keine nennenswerte Kontrastmittelaufnahme. 
### Was kann man nicht sehen?
 Verkalkungen und Gas sind schlechter darstellbar als im CT. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die MRT ist der CT in der Darstellung von perianalen Fisteln überlegen und wird wegen der fehlenden Strahlenbelastung besonders bei jungen Patienten bevorzugt.
