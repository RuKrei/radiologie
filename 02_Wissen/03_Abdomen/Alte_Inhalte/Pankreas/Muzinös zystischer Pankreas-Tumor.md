...
### Was sieht man korrelierend in dieser Methode?
 Transabdominell zeigt sich eine zystische Läsion, die jedoch eine niedrige Trefferquote in der spezifischen Diagnostik aufweist. In der Endosonografie lassen sich Gewebsproliferationen gut darstellen. Zudem können polyzystische, gut vaskularisierte Läsionen mit soliden Anteilen und Septen gesehen werden. 
### Was kann man nicht sehen?
 Die transabdominelle Sonografie ist in der Differenzierung oft limitiert. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die Endosonografie ermöglicht eine Biopsie mit Analyse des Zysteninhalts (muzinös, erhöhte Tumormarker, keine erhöhte Amylase), was zur Differenzierung wichtig ist.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 Es liegen in den Quellen keine spezifischen Angaben zur konventionellen Röntgendiagnostik vor, abgesehen von der generellen Erwähnung von Verkalkungen in der Bildgebung. 
### Was kann man nicht sehen?
 Die Weichteilarchitektur und Zystenstruktur sind im Röntgen nicht beurteilbar. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die Methode ist für die Primärdiagnostik nicht geeignet.
...
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die Differenzierung zu anderen zystischen Läsionen kann im CT schwierig sein, wenn charakteristische Merkmale fehlen.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 In der MRT zeigen sich unilokuläre oder wenig septierte Tumoren mit glatter Kontur und meist dicker Außenwand, die verzögert Kontrastmittel aufnimmt. Der Zysteninhalt weist in T1-gewichteten Bildern ein homogen niedriges Signal und in T2-gewichteten Bildern ein hohes Signal auf. Bei muzinhaltigen oder hämorrhagischen Zysten kann das Signal in T1 und T2 hyperintens sein. Septen sind gut demarkiert und nehmen Kontrastmittel auf. In der MRCP lässt sich das Fehlen einer Kommunikation mit dem Pankreasgang nachweisen,. 
### Was kann man nicht sehen?
...
Pankreaspseudozysten: Diese sind Folgen einer Pankreatitis, zeigen oft ein atrophes Pankreasgewebe mit Verkalkungen und irreguläre Gangerweiterungen.

Seröses Zystadenom: Besteht aus vielen kleinen, wabenartig angeordneten Zysten (mikrozystisch), tritt meist bei älteren Frauen auf und zeigt manchmal eine zentrale sternförmige Narbe,.

Intraduktale papillär-muzinöse Neoplasie (IPMN): Diese Läsionen kommunizieren mit dem Pankreasgangsystem, was bei MCN nicht der Fall ist,.

Solider papillärer Tumor: Tritt überwiegend bei jungen Frauen auf, zeigt solide und zystische Anteile sowie Hämorrhagien.
