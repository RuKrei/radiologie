...
### Zu welchen pathologischen Veränderungen kommt es?
 Es handelt sich um eine submuköse Ansammlung von Pankreasgewebe (Azini, Gänge, Inselzellen), die sich als rundliche Vorwölbung darstellt,. 
...
### Was sieht man korrelierend in dieser Methode?
 In der Sonografie und insbesondere der Endosonografie zeigt sich ein homogener, echoarmer Knoten, der meist submukös lokalisiert ist. 
### Was kann man nicht sehen?
 Die definitive histologische Zuordnung ist bildgebend nicht immer sicher möglich, eine Feinnadelbiopsie kann jedoch diagnostisch ergiebig sein. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 In etwa der Hälfte der Fälle lässt sich sonografisch ein rudimentärer Gang innerhalb der Läsion erkennen.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 In Magen-Darm-Passagen (Fluoroskopie) stellt sich das ektope Pankreas typischerweise als submuköser Füllungsdefekt dar, oft mit einer zentralen Ansammlung von Kontrastmittel (Bull's-eye-Läsion oder Target-Läsion), welche die Mündung des rudimentären Ganges repräsentiert,. 
### Was kann man nicht sehen?
 Die Weichteilcharakteristik ist im Röntgen nicht beurteilbar. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die zentrale Umbilikation ist ein wichtiges differenzialdiagnostisches Kriterium gegenüber anderen submukösen Läsionen.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 Im CT imponiert das ektope Pankreas als submuköse, ovaläre Raumforderung, die sich meist im Magenantrum oder Duodenum vorwölbt. Das Gewebe weist Dichtewerte und ein Kontrastmittelverhalten auf, die dem des regulären Pankreas entsprechen. 
### Was kann man nicht sehen?
 Die Abgrenzung gegen das umgebende Gewebe ist oft unscharf. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Bei submuköser Lage zeigt die darüberliegende Schleimhaut oft eine deutlich verstärkte Kontrastmittelaufnahme, was auf eine begleitende Gastritis hinweisen kann.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 In der MRT stellt sich die Läsion als submuköse ovaläre Raumforderung dar, die in allen Sequenzen isointens zum regulären Pankreasgewebe ist,,. Auch das Kontrastmittelverhalten entspricht dem des orthotopen Pankreas. 
### Was kann man nicht sehen?
 Kleine Läsionen können schwer zu detektieren sein. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 In manchen Fällen lässt sich ein rudimentäres Gangsystem innerhalb der Läsion darstellen, was diagnostisch wegweisend ist,.
...
Peptisches Ulkus: Kann bei ödematösem Randsaum ebenfalls als Target-Läsion (Bull's-eye) imponieren.
