...
Tags: #Radiologie #Thorax #Lunge #HRCT
-----
# Wer? (Epidemiologie und Symptome)
Systematische Analyse von Hochauflösender Computertomographie (HRCT) der Lunge zur Diagnose von interstitiellen Lungenerkrankungen (ILD).
- **Protokoll:** Dünne Schichten (< 1.5 mm), kantenanhebender Kernel (B70f o.ä.), Inspiration + Exspiration (wichtig für Air-Trapping!).
- **Klinik:** Dyspnoe, Reizhusten, basales Knisterrasseln ("Sklerosiphonie").

# Bildgebung (morphologische/ pathologische Veränderungen)

## Grundmuster (Basic Patterns)
...
### 5. Konsolidierung
Homogene Verdichtung, Gefäße nicht mehr sichtbar, oft Luftbronchogramm.
- **Ursache:** Komplette Alveoläre Füllung.
- **Pneumonie:** Lobärpneumonie.
- **Organisierende Pneumonie (COP):** Wandert oft, subpleural/peribronchial.
- **Eosinophile Pneumonie:** "Photonegatives Ödem" (peripher betont).
- **Adenokarzinom:** Lepidic growth (muzinös).
- **Lymphom:** MALT-Lymphom.

### 6. Mosaikperfusion / Air-Trapping
...
## Wichtige Krankheitsbilder und ihre Muster
...
- **Chronisch:** Fibrose (oft Oberlappenbetont!), Mosaikmuster, Air-Trapping. "Three-Density-Pattern".
