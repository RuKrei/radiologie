...
---
------
PEG = Morbus Boeck, Granulomatose, Lungenfibrose
Erstellt: 2026-02-28
...
Nicht verkäsende Granulome in Lunge (lymphangitische Ausbreitung entlang der Bronchovaskulären Bündel) und Lymphknoten (hilär/mediastinal).

### Zu welchen morphologischen Veränderungen kommt es?
- **Lymphadenopathie:** Symmetrisch bihiliär (klassisch!), oft + rechtes paratracheales Band ("1-2-3-Sign" / "Garland-Triad").
- **Lungenparenchym:** Mikronoduläre Zeichnungsvermehrung (perilymphatisch: entlang Bronchien/Pleura/Fissuren), Konsolidierungen ("Alveoläre Sarkoidose" - selten), Fibrose (Oberlappenbetont!).

## Röntgen
### Was sieht man korrelierend in dieser Methode?
**Scadding-Stadien (Prognostisch relevant!):**
- **Stadium 0:** Normalbefund (Extrathorakale Manifestation).
...
## CT (HRCT)
### Was sieht man korrelierend in dieser Methode?
**Goldstandard zur Beurteilung des Parenchyms.**
- **Lymphknoten:** Symmetrisch vergrößert, oft nicht nekrotisch/verkalkt (außer alt: "Eierschalenverkalkung").
...
- Atypische Manifestationen: Unilaterale LK, solitärer Rundherd, Kavitationen (nekrotisierende Sarkoidose - sehr selten!).
- **Herzbeteiligung:** Kardio-MRT wichtig (Late Gadolinium Enhancement oft subepikardial/midmyokardial, basal septal). Risiko für Rhythmusstörungen/Plötzlichen Herztod!

## MRT
### Was sieht man korrelierend in dieser Methode?
- **Kardiale Sarkoidose:** LGE (Late Gadolinium Enhancement) fleckig, oft nicht koronar zuordenbar. T2-Ödem in akuter Phase.
- **Neurosarkoidose:** Leptomeningeales Enhancement (basal), hypophysär.
- **Muskuloskelettal:** "Lace-like" (spitzenartiges) Muster in Knochen (Phalangen).
