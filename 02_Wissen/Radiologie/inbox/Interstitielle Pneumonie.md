...
- **Zu welchen pathologischen Veränderungen kommt es?** Die Entzündung spielt sich primär im Interstitium (Alveolarsepten, peribronchovaskuläres und interlobuläres Bindegewebe) ab. Es kommt zu einer Verdickung der Septen durch Ödem und zelluläre Infiltration (Lymphozyten, Plasmazellen, Makrophagen). Sekundär sind oft Alveolen und Bronchioli mitbetroffen (gemischt interstitiell-alveoläre Infiltrate),. Bei chronischen Verlaufsformen (IIP) steht der fibrotische Umbau im Vordergrund.
- **Zu welchen morphologischen Veränderungen kommt es?** Leitbefund sind retikuläre (netzartige) oder retikulonoduläre Zeichnungsvermehrungen sowie Milchglastrübungen (Ground-Glass Opacity). Die anatomischen Grenzen (Lappenspalten) werden oft nicht respektiert; das Bild ist häufig bilateral und diffus,.
- **Zu welchen Komplikationen kann es kommen?**
    - Respiratorische Insuffizienz (ARDS-Bild bei schwerem Verlauf, z. B. AIP oder schwere Virus-Pneumonie),.
    - Superinfektion (bakteriell) mit dann alveolären Konsolidierungen.
    - Lungenfibrose (bei chronischen Formen oder als Defektheilung).
    - Pneumothorax (insb. bei Pneumocystis-Pneumonie oder zystischen Veränderungen),.

**Sonografie**

- **Was sieht man korrelierend in dieser Methode?** Die Quellen machen keine spezifischen Angaben zur Sonografie bei der reinen interstitiellen Pneumonie. Generell können pleurale Begleitergüsse oder pleuraständige Konsolidierungen detektiert werden, wobei reine interstitielle Prozesse oft nur unspezifische Artefakte (B-Linien) verursachen, die in den Quellen im Kontext des Lungenödems, aber nicht explizit hier detailliert werden.

**Röntgen**

- **Was sieht man korrelierend in dieser Methode?**
    
    - **Muster:** Bilateral symmetrische lineare, retikuläre oder retikulonoduläre Verdichtungen. Häufig finden sich milchglasartige Trübungen (schleierartige Transparenzminderung), die die Gefäßstrukturen unscharf erscheinen lassen, aber nicht komplett maskieren,.
    - **Verteilung:** Oft perihilär beginnend und in die Peripherie reichend (sog. „hilärer Strahlenkranz“). Die Hili können verdichtet und unscharf begrenzt wirken.
    - **Spezifische Erreger-Hinweise:**
        - _Viruspneumonie:_ Retikuläre Zeichnungsvermehrung, perihiläre Betonung, ggf. Kerley-Linien (septale Verdickung).
        - _Mykoplasmen:_ Oft diskrete interstitielle Infiltrate, die später fleckig konfluieren können; das Röntgenbild hinkt der Klinik oft hinterher.
        - _Pneumocystis (PcP):_ Perihiläre, schmetterlingsförmige milchglasartige Trübungen („Lungenödem ohne Herzinsuffizienz“),.
- **Was kann man nicht sehen?** Diskrete Milchglastrübungen entgehen dem Röntgenbild häufig. Bei PcP ist der Röntgenbefund in bis zu 10 % der Fälle trotz Klinik (Dyspnoe) unauffällig.
    
- **Gibt es wichtige Befunde/Aspekte, die man übersehen kann?** Die Diskrepanz zwischen einem blanden Röntgenbefund und schwerer Hypoxie ist typisch für interstitielle Prozesse (insb. PcP) und sollte nicht zur Fehleinschätzung „gesund“ verleiten.
    

**CT**

- **Was sieht man korrelierend in dieser Methode?** Die CT (insb. HRCT) ist die Methode der Wahl. Leitbefund ist die **Milchglastrübung** (Dichteanhebung, bei der Gefäße noch sichtbar sind) und/oder das **retikuläre Muster**,.
    
    _Differenzierung nach Formen:_
...
- **Gibt es wichtige Befunde/Aspekte, die man übersehen kann?** Bei immunsupprimierten Patienten (z. B. nach Stammzelltransplantation) können interstitielle Muster auch einem Engraftment-Syndrom, einer Medikamententoxizität oder einer Hämorrhagie entsprechen – die Klinik ist entscheidend,.
