...
### Was sieht man korrelierend in dieser Methode?
 Frisches Blut stellt sich echofrei dar. Nach 24 Stunden wird es echoreich und nach 4 bis 5 Tagen echoarm. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Nach mehreren Wochen sind bei einem organisierten Hämatom interne Septierungen zu erkennen.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 Die konventionelle Röntgendiagnostik spielt für die direkte Diagnostik der Leberblutung keine primäre Rolle. 
### Was kann man nicht sehen?
 Spezifische Parenchymveränderungen sind nicht darstellbar.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 Die CT ist eine Methode der Wahl. Frisches Blut stellt sich hyperdens dar, älteres Blut hypodens. Nach einem Trauma sind Lazerationen insbesondere nach Kontrastmittelgabe gut als hypodense Areale zu erkennen. Eine aktive Blutung zeigt sich durch eine Kontrastmittel-Extravasation. Subkapsuläre Hämatome haben typischerweise eine bikonvexe Form und komprimieren das angrenzende Leberparenchym. 
### Was kann man nicht sehen?
 Bei der Ruptur eines Tumors sind die zugrunde liegenden Herde meist nicht mehr zu erkennen. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Intraparenchymatöse Hämatome können im Gegensatz zu subkapsulären Hämatomen über Jahre persistieren. Eine periportale Dichteabsenkung (periportales Tracking) kann als indirektes Zeichen einer Leberverletzung auftreten,,,,,.

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 Die MRT spielt in der Akutphase der Leberblutung keine Rolle.
...
Gefäßerkrankung: Gelegentlich ist ein Aneurysma oder sind kaliberstarke Arterien nachweisbar.

Koagulopathie: Gekennzeichnet durch niedrige Thrombozytenzahl, Gerinnungsdefekte und rezidivierende Blutungsepisoden.
