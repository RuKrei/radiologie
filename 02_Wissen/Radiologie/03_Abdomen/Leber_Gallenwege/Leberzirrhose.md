...
### Zu welchen pathologischen Veränderungen kommt es?
 Es kommt zu Zellnekrosen mit reaktiven fibrotischen und regenerativen Veränderungen, die die normale Leberarchitektur zerstören. Das Leberparenchym wird durch Bindegewebe ersetzt. 
...
### Was sieht man korrelierend in dieser Methode?
 Die Sonografie ist oft das primäre Untersuchungsverfahren. Die Leberkontur erscheint höckerig, das Organ verformt und die Parenchymstruktur gemischt echoarm und echoreich. Im Farbdoppler zeigt sich oft eine prominente Leberarterie mit erhöhtem Fluss sowie eine Umkehr des Pfortaderflusses bei fortgeschrittener portaler Hypertension. Aszites und Splenomegalie sind gut darstellbar. 
### Was kann man nicht sehen?
 Die Differenzierung zwischen regenerativen, dysplastischen und malignen Knoten kann sonografisch schwierig sein, insbesondere bei kleinen Befunden.
...
### Was sieht man korrelierend in dieser Methode?
 Die CT zeigt die höckerige Oberfläche und das heterogene Parenchym mit Knoten unterschiedlicher Größe. Ein vergrößertes Verhältnis der axialen Ausdehnung des Lobus caudatus zum rechten Leberlappen (größer als 0,65) sowie eine Erweiterung der Leberfurchen (expanded gallbladder fossa sign) sind typische Zeichen. Siderotische Knoten können aufgrund des Eisengehalts hyperdens wirken. Die Kontrastmittelanreicherung ist oft sehr heterogen. Extrahepatisch finden sich Varizen, Aszites und Splenomegalie. 
### Was kann man nicht sehen?
 Bei Frühformen kann das CT-Bild in bis zu 25 Prozent der Fälle normal erscheinen. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Ein Pseudolipom der Vena cava inferior kann durch Fettgewebe oberhalb des hypertrophen Lobus caudatus vorgetäuscht werden (Partialvolumeneffekt).

## MRT
 
### Was sieht man korrelierend in dieser Methode?
 Fibrotische Veränderungen (verbreitertes Periportalfeld, netzartige Strukturen) stellen sich in T1-gewichteten Sequenzen hypointens und in T2-gewichteten Sequenzen meist hyperintens dar. Regeneratknoten sind in T1 oft hypo- bis hyperintens und in T2 hypointens. Siderotische Knoten erscheinen in T1 und T2 hypointens. Dysplastische Knoten sind häufig T1-hyperintens und T2-hypointens. Das HCC zeigt typischerweise ein arterielles Enhancement mit venösem Wash-out und Diffusionsrestriktion,. Leberspezifische Kontrastmittel können helfen, fibrotische von regenerativen Arealen zu unterscheiden. 
### Was kann man nicht sehen?
 Die Unterscheidung zwischen dysplastischen Knoten und hochdifferenzierten HCCs kann auch im MRT herausfordernd sein, insbesondere bei kleinen Läsionen ohne typisches Wash-out. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Hyperintense Regeneratknoten in der arteriellen Phase können fälschlicherweise als HCC interpretiert werden, gleichen sich aber in späteren Phasen dem Parenchym an.

# Differenzialdiagnosen


Pseudozirrhose bei metastasiertem Mammakarzinom: Unter Chemotherapie kann die Leber eine diffuse Nodularität entwickeln, die einer Zirrhose ähnelt, oft begleitet von Zeichen einer portalen Hypertension.
