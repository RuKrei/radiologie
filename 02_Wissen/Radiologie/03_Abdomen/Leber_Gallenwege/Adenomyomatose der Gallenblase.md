...
### Zu welchen pathologischen Veränderungen kommt es?
 Es kommt zu einer exzessiven Proliferation des Oberflächenepithels mit tiefen Invaginationen (Divertikeln) in die verdickte Muskelschicht der Gallenblasenwand. Diese intramuralen Aussackungen (Rokitansky-Aschoff-Sinus) können Galle, Sludge, Cholesterolkristalle oder Steine enthalten. 
...
### Was sieht man korrelierend in dieser Methode?
 Es zeigt sich eine umschriebene oder generalisierte Wandverdickung mit erweiterten Sinus, die echofrei sein können oder Einschlüsse aufweisen. Charakteristisch sind Kometenschweif-Artefakte (Reverberationen), die durch Cholesterolkristalle in den Sinus entstehen. Die Läsionen sind bei Lageänderung nicht mobil. 
### Was kann man nicht sehen?
 Wenn keine Kristalle oder Steine in den Sinus enthalten sind, können die spezifischen Artefakte fehlen, was die Differenzierung erschwert. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Bei der sanduhrförmigen (segmentalen) Form kann das distale Kompartiment der Gallenblase im Ultraschall übersehen werden, was bei einer Operation zu einer inkompletten Cholezystektomie führen kann.

## Röntgen
 
### Was sieht man korrelierend in dieser Methode?
 In der oralen Cholezystografie (heute kaum noch durchgeführt) oder als Zufallsbefund bei einer ERCP füllen sich die Rokitansky-Aschoff-Sinus mit Kontrastmittel, was ein sehr eindrucksvolles Bild ergibt. 
### Was kann man nicht sehen?
 Die Wanddicke und Weichteilstrukturen sind ohne Füllung der Sinus nicht direkt beurteilbar. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die Methode ist diagnostisch nicht mehr indiziert.

## CT
 
### Was sieht man korrelierend in dieser Methode?
 Die CT zeigt eine verdickte Gallenblasenwand, wobei die intramuralen Divertikel oft als hypodense Areale sichtbar sind. Ein spezifisches Zeichen ist das Rosary Sign (Rosenkranz-Zeichen), bei dem die anreichernde Mukosa der Sinus von der nicht anreichernden hypertrophen Muskulatur umgeben ist. Die Außenkontur ist glatt. 
### Was kann man nicht sehen?
...
### Was sieht man korrelierend in dieser Methode?
 Die MRT hat die höchste Genauigkeit bei der Diagnose. In T2-gewichteten Sequenzen stellen sich die flüssigkeitsgefüllten Rokitansky-Aschoff-Sinus als stark hyperintense Punkte in der verdickten Wand dar, was als Pearl Necklace Sign (Perlenketten-Zeichen) bezeichnet wird. In der MRCP zeigt sich bei der generalisierten Form das Bild einer Perlschnurgallenblase. 
### Was kann man nicht sehen?
 Kleine Steine innerhalb der Sinus können schwer abgrenzbar sein. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Bei konzentrierter Galle oder Einblutungen können die Sinus auch in T1-gewichteten Sequenzen hyperintens erscheinen.
...
Varizen der Gallenblasenwand: Können eine Wandverdickung vortäuschen, sind aber nach Kontrastmittelgabe als Gefäße identifizierbar und treten im Kontext einer portalen Hypertension auf.
