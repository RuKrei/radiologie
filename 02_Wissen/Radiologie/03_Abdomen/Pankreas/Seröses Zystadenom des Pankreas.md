...
### Zu welchen pathologischen Veränderungen kommt es?
 Der Tumor besteht aus zystischen Hohlräumen, die von kubischem, glykogenreichem Epithel ausgekleidet sind und seröse Flüssigkeit enthalten. Es werden drei Varianten unterschieden: Der häufigste mikrozystische Typ (Honigwaben- oder Schwamm-Muster), der seltener vorkommende makrozystische (oligozystische) Typ mit wenigen, größeren Zysten (über 2 cm) und extrem selten die solide Variante. 
...
### Was sieht man korrelierend in dieser Methode?
 Der Tumor imponiert als gut abgrenzbare, lobulierte Raumforderung. Aufgrund der vielen Grenzflächen der zahlreichen Mikrozyten kann der Tumor im Ultraschall echoreich oder pseudo-solide wirken. Bei größeren Zysten ist das Bild einer multizystischen Läsion (Trauben-Aspekt) erkennbar. 
...
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Da Verkalkungen nur in etwa 30 Prozent der Fälle auftreten, ist die Sensitivität gering.
...
### Was sieht man korrelierend in dieser Methode?
 Die MRT ist die Methode der Wahl zur Charakterisierung. Die Zysten stellen sich in T2-gewichteten Sequenzen als stark hyperintenses Cluster (Trauben oder Glühbirnen) dar. Die zentrale Narbe und die Septen erscheinen in T1- und T2-Wichtung hypointens. Nach Kontrastmittelgabe zeigen die Septen und die Narbe eine Anreicherung. Die MRCP ist essenziell, um das Fehlen einer Kommunikation mit dem Pankreasgang zu beweisen. 
### Was kann man nicht sehen?
 Verkalkungen sind in der MRT schlechter zu erkennen als in der CT und stellen sich als Signalauslöschungen dar. 
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Die MRT ist besonders hilfreich bei der makrozystischen Variante, um Septen und Wandstrukturen darzustellen, die im CT möglicherweise nicht sichtbar sind,,,.

# Differenzialdiagnosen


Muzinöse zystische Neoplasie (MCN): Diese tritt fast ausschließlich bei Frauen mittleren Alters (um 45 Jahre) auf, liegt bevorzugt im Pankreaskorpus oder -schwanz, besteht aus wenigen großen Zysten (makrozystisch), hat keine zentrale Narbe und weist ovarielles Stroma auf.
...
Solider pseudopapillärer Tumor: Tritt meist bei jungen Frauen auf und zeigt häufig Einblutungen sowie solide und zystische Anteile,.
