...
### Zu welchen morphologischen Veränderungen kommt es?
 Die Darmwand ist im distendierten Zustand auf über 3 mm verdickt. In der aktiven Phase zeigt sich eine starke Kontrastmittelaufnahme. Im fortgeschrittenen Stadium kommt es zum Verlust der Haustrierung, was dem Darm ein schlauchförmiges Aussehen verleiht (Fahrradschlauch-Kolon). Nach Abheilung können atrophische Schleimhaut und entzündliche Pseudopolypen verbleiben,.


### Zu welchen Komplikationen kann es kommen?
 Zu den Komplikationen zählen das toxische Megakolon (Durchmesser über 5 bis 6 cm), Perforationen, narbige Strikturen und die Entwicklung eines Kolonkarzinoms.
...
### Was sieht man korrelierend in dieser Methode?
 Die Sonografie ist eine wichtige Methode zur Primärdiagnostik. Man sieht eine verdickte Darmwand, die im floriden Stadium im Farbdoppler oder bei Verwendung von Kontrastmitteln sehr stark durchblutet ist. Die Peristaltik der verdickten Darmabschnitte ist vermindert. Stenosen sind sonografisch gut nachweisbar.
...
### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Kollabierte Darmschlingen können eine Wandverdickung vortäuschen.
...
### Was sieht man korrelierend in dieser Methode?
 Die Abdomenübersichtsaufnahme dient dem Nachweis eines toxischen Megakolons, definiert durch einen Durchmesser von über 5 bis 6 cm, sowie dem Nachweis von irregulären Wandverdickungen oder dem Fehlen von Stuhl im Dickdarm. Der Kolonkontrasteinlauf (heute weitgehend obsolet) zeigt eine samtartige, granulierte Schleimhautoberfläche, Ulzerationen und im Spätstadium den Verlust der Haustrierung (Fahrradschlauch) sowie Pseudopolypen,.


### Was kann man nicht sehen?
 Die Sensitivität für frühe Schleimhautveränderungen ist geringer als in der Endoskopie.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Der Kolonkontrasteinlauf ist durch die Endoskopie abgelöst worden.
...
### Was sieht man korrelierend in dieser Methode?
 Man sieht eine verdickte Darmwand mit kräftiger Kontrastmittelaufnahme in der floriden Entzündungsphase. Die CT erlaubt eine gute Beurteilung von meist langstreckigen Stenosen. Sie ist vorwiegend bei Komplikationen wie einer Perforation indiziert.


### Was kann man nicht sehen?
 Die Differenzierung der Wandschichten ist weniger detailliert als im MRT oder Endosonografie.


### Gibt es wichtige Befunde/Aspekte, die man übersehen kann?
 Ein normaler CT-Befund schließt frühe Stadien nicht sicher aus, da die Veränderungen primär mukosal sind.
...
### Was sieht man korrelierend in dieser Methode?
 Es zeigt sich eine Verdickung der Darmwand. In T2-gewichteten Sequenzen mit Fettunterdrückung lässt sich die akute Entzündung als Ödem mit starkem Signal in der Darmwand und ihrer Umgebung gut darstellen. Nach Kontrastmittelgabe kann eine Dreischichtung der Wand sichtbar sein. Die MRT eignet sich gut zur Darstellung von Stenosen. Das Befallsmuster ist charakteristischerweise kontinuierlich von rektal aufsteigend,.


### Was kann man nicht sehen?
 Die Methode spielt im Vergleich zur Endoskopie eine untergeordnete Rolle in der Primärdiagnostik.
