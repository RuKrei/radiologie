...
Zu welchen pathologischen Veränderungen kommt es? Pathologisch liegt eine Hyperplasie der Schleimdrüsen (vergrößerter Reid-Index), eine Entzündung sowie eine Hypertrophie der glatten Muskulatur vor. Es besteht eine Störung des physiologischen Gleichgewichts zwischen Proteasen und Proteaseinhibitoren sowie oxidativer Stress.
...
Was sieht man korrelierend in dieser Methode? Die Sonografie spielt für die Diagnose der chronischen Bronchitis primär keine Rolle. Sie dient eher dem Nachweis von Komplikationen wie Pleuraergüssen oder der Beurteilung der Zwerchfellbeweglichkeit.

Was kann man nicht sehen? Veränderungen des Lungenparenchyms und der Bronchialwände sind sonografisch in der Regel nicht beurteilbar, solange sie nicht pleuraständig sind oder Konsolidierungen vorliegen.

Gibt es wichtige Befunde/Aspekte, die man übersehen kann? Intrapulmonale Prozesse entziehen sich der sonografischen Diagnostik.

Röntgen

Was sieht man korrelierend in dieser Methode? Häufig ist die Thoraxaufnahme unauffällig. Wenn Veränderungen sichtbar sind, handelt es sich um unspezifische Befunde wie eine verdickte Bronchialwandzeichnung. Orthograd getroffene Bronchien zeigen sich als Ringstrukturen (peribronchiales Cuffing), tangential getroffene als parallele Linien (Tram-Lines oder Schienenphänomen). Eine diffuse interstitielle Zeichnungsvermehrung, oft als Dirty Chest bezeichnet, kann vorkommen, ist jedoch schwer zu objektivieren. Bei obstruktiver Komponente finden sich Zeichen der Überblähung (Fassthorax, abgeflachtes Zwerchfell). Die Trachea kann eine Säbelscheidenform annehmen (koronaler Durchmesser weniger als zwei Drittel des sagittalen Durchmessers).

Was kann man nicht sehen? Die Sensitivität für reine Atemwegserkrankungen ohne begleitendes Emphysem oder grobe Verdickungen ist gering. Frühe Stadien entgehen dem Nachweis.

Gibt es wichtige Befunde/Aspekte, die man übersehen kann? Periphere mikronoduläre Veränderungen (1-2 mm) können Ausdruck einer chronischen Raucherbronchitis sein und mit anderen interstitiellen Erkrankungen verwechselt werden.
...
Gibt es wichtige Befunde/Aspekte, die man übersehen kann? Strukturelle Details des Lungenparenchyms.
