...
------
Erstellt: 2026-04-23
Zuletzt bearbeitet: 2026-04-23
Tags: #HRCT #Fleischner #Mustererkennung #Thorax
-----
# Deep Dive: HRCT Mustererkennung (Fleischner Society Glossary)

Dieser Artikel fasst die wichtigsten Muster und Definitionen der **Fleischner Society** für die HRCT (High-Resolution Computed Tomography) des Thorax zusammen. Die korrekte Terminologie ist entscheidend für die Beschreibung diffuser Lungenparenchymerkrankungen (ILDs) und für die Facharztprüfung.

## 1. Erhöhte Lungendichte (High Attenuation Patterns)

### Ground-Glass Opacity (Milchglasverdichtung)
...
- **Definition:** Homogene Dichteanhebung der Lunge, die so stark ist, dass Gefäß- und Bronchialwände **nicht mehr abgrenzbar** sind (häufig mit positivem Aerobronchogramm).
...
## 2. Verminderte Lungendichte (Low Attenuation Patterns)

### Emphysem
- **Definition:** Permanent erweiterte Lufträume distal der terminalen Bronchiolen mit Destruktion der Alveolarwände, *ohne* wesentliche Fibrose.
- **Subtypen:**
  - **Zentrilobulär:** Zerstörung im Zentrum des sekundären Lobulus (respiratorische Bronchiolen). Prädilektion: Oberlappen. Klassisch bei Rauchern.
  - **Panlobulär (Panazinär):** Homogene Zerstörung des gesamten Lobulus. Prädilektion: Unterlappen. Klassisch bei Alpha-1-Antitrypsin-Mangel.
  - **Paraseptal (Distales azinäres Emphysem):** Entlang der Pleura und Septen. Führt oft zu spontanem Pneumothorax bei jungen Erwachsenen.
...
## 3. Noduläre Muster (Nodular Patterns)
...
## 4. Lineare und retikuläre Muster
...
# Differenzialdiagnostische Algorithmen (Fibrose)
...
- **NSIP:** 
  - Basal dominant, oft relative Aussparung der unmittelbaren Subpleura (Subpleural Sparing).
  - Vorwiegend **Milchglas** und feine Retikulation.
  - *Kein* Honeycombing.

### Hypersensitivitätspneumonitis (HP - chronisch)
